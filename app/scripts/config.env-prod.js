...
(function () {
    ...
    angular.module('app')
        ...
        .constant('uploadedImageBaseUrl', 'http://ads.everstring.com:5000/uploads/images/')
        .constant('logoutUrl', 'http://cas.everstring.com/logout')
        .constant('casUrl', 'https://cas.everstring.com:15000/v1.0/');  //http://192.168.0.181:5000/ads/    http://52.5.48.109:5000/ads/
